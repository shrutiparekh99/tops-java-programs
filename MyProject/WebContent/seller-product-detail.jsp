        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h4>Product Category : <%=p.getProduct_category() %></h4>
                    
                    <h3 class="font-weight-semi-bold mb-4">Price: <%=p.getProduct_price() %></h3>
                    <p class="mb-4">Product Description : <%=p.getProduct_desc() %></p>
