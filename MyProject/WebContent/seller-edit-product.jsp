			...
			<div class="col-12">
				<nav class="breadcrumb bg-light mb-30">
					<a class="breadcrumb-item text-dark" href="#">Home</a> <span
						class="breadcrumb-item active">Edit Product</span>
				</nav>
			</div>
		</div>
	</div>
                       ...
                       <form method="post" action="ProductController"
						...
						<div class="control-group">
							<input type="text" class="form-control" name="product_name"
								id="name" value="<%=p.getProduct_name()%>" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
							<input type="text" class="form-control" name="product_price"
								id="name" value="<%=p.getProduct_price()%>" />
							<p class="help-block text-danger"></p>
						</div>

						<div class="control-group">
							<textarea class="form-control" rows="8" name="product_desc"
								id="message" placeholder="Desciption"><%=p.getProduct_desc()%></textarea>
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="Update Product">Update Product</button>
						</div>
					</form>
				</div>
			</div>
